...
BLOG_AUTHOR = "Sebastian Riehm"  # (translatable)
BLOG_TITLE = "7-zip.de"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://7-zip.de/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://7-zip.de/"
BLOG_EMAIL = "kontakt@7-zip.de"
BLOG_DESCRIPTION = "Deutsche Webseite von 7-Zip."  # (translatable)
...
NAVIGATION_ALT_LINKS = {
    DEFAULT_LANG: (
        ...
        ("https://www.7-zip.fr/", "Französisch"),
...
# POSTS_SECTIONS = True  # Deprecated - replaced by categories
...
OUTPUT_FOLDER = '/home/sevenzip/html'
...
# (translatable)
CONTENT_FOOTER = 'Copyright (C) {date} Igor Pavlov'
...
DISABLED_PLUGINS = ["chart", "classify_archive", "classify_authors", "classify_categories", "classify_indexes", "classify_page_index", "classify_tags", "classify_taxonomies", "emoji", "gist", "github_deploy", "import_wordpress", "init", "ipynb", "listing_shortcode", "mako", "markdown", "mdx_gist", "mdx_podcast", "new_page", "new_post", "post_list", "render_galleries", "render_listings", "render_sources", "render_tag_cloud", "render_taxonomies", "rest_chart", "rest_gist", "rest_listing", "rest_media", "rest_post_list", "rest_soundcloud", "rest_thumbnail", "rest_vimeo", "rest_youtube"]
...
DISABLE_INDEXES_MAIN_ATOM_FEED = True
DISABLE_INDEXES_MAIN_RSS_FEED = True
