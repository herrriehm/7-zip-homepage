...
**7-Zip 21.06 (24.11.2021) für Windows herunterladen**:
...
.. list-table::
   ...
   * - Link
     ...
     - Windows
     - Größe
   * - `Download <https://7-zip.org/a/7z2106-x64.exe>`__
     - .exe
     - 64-bit x86
     - 1,5 MB
   * - `Download <https://7-zip.org/a/7z2106.exe>`__
     - .exe
     - 32-bit x86
     - 1,2 MB
   * - `Download <https://7-zip.org/a/7z2106-arm64.exe>`__
     - .exe
     - 64-bit ARM64
     - 1,5 MB
