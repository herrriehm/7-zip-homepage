.. title: 7-Zip
.. slug: index
.. date: 2024-11-30T15:02:25+01:00
.. tags:
.. category:
.. link:
.. description:
...
**7-Zip 24.09 (29.11.2024) für Windows x64 (64-bit) herunterladen**:
...
.. list-table::
   ...
   * - Link
     ...
     - Windows
     - Größe
   * - `Download <https://7-zip.org/a/7z2409-x64.exe>`__
     - .exe
     - 64-bit x64
     - 1,6 MB

**7-Zip 24.09 für andere Windows-Plattformen (32-bit x86 oder ARM64) herunterladen**:
...
.. list-table::
   ...
   * - Link
     ...
     - Windows
     - Größe
   * - `Download <https://7-zip.org/a/7z2409.exe>`__
     - .exe
     - 32-bit x86
     - 1,3 MB
   * - `Download <https://7-zip.org/a/7z2409-arm64.exe>`__
     - .exe
     - 64-bit ARM64
     - 1,5 MB
