...
**Download von 7-Zip 21.05 (20.11.2021)**:
...
.. table::
    ...
    +======================================================+====================+======================+===================================================================================+
    | `Download <https://7-zip.org/a/7z2105-x64.exe>`__    | .exe               | 64-bit Windows x64   | 7-Zip für Windows                                                                 |
    +------------------------------------------------------+--------------------+----------------------+                                                                                   |
    | `Download <https://7-zip.org/a/7z2105.exe>`__        | .exe               | 32-bit Windows x86   |                                                                                   |
    +------------------------------------------------------+--------------------+----------------------+                                                                                   |
    | `Download <https://7-zip.org/a/7z2105-arm64.exe>`__  | .exe               | 64-bit Windows arm64 |                                                                                   |
    +------------------------------------------------------+--------------------+----------------------+-----------------------------------------------------------------------------------+
