...
.. table::
    ...
    +==========================================================+=======+============+=============+====================================+
    | `Download <https://7-zip.org/a/lzma2200.7z>`__           |  1 MB | 15.06.2022 | 22.00       | | LZMA SDK                         |
    +----------------------------------------------------------+-------+------------+-------------+ | C, C++, C#, Java                 |
    | `Download <https://7-zip.org/a/lzma2107.7z>`__           |  1 MB | 26.12.2021 | 21.07       | | x86/x64-Binärdateien für Windows |
    +----------------------------------------------------------+-------+------------+-------------+                                    |
